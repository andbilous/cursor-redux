...
import { Col, Form, FormGroup, Label, Input,Input } from 'reactstrap';
...
const FormContainer = () => {
  return (
    ...
    <FormGroup style={style.row}>
        ...
        <Input onChange={(e) => this.onChange(`${e.target.value}`)} type="select" id="exampleCustomSelect" name="customSelect">
